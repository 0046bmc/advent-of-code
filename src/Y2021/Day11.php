...
5283751526';
    ...
    {
        $O = Map2D::createFromString($input);
    ...
    private function incEm(Map2D &$O, array $flashed): void
    {
    ...
    private function flashEm(Map2D &$O, array &$flashed, int &$flashcount): void
    {
    ...
    private function countNines(Map2D &$O): int
    {
        $return = 0;
